...
function addNewForm() {
    ...
    var $panel = $('<div class="panel panel-warning border bg-info-alt"><div class="panel-heading"><strong>Phone '+$collectionHolder.data('index')+'</strong></div></div>');
